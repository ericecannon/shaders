Shader "Spine/Sprite/Vertex Lit Invisible"
{
	Properties
	{
		...
		//_DualSidedLighting ("Dual Sided Lighting", Float) = 1.0
	...
	SubShader
	{
		...
		Pass
		{
			...
			CGPROGRAM
				...
				#pragma shader_feature _DUAL_SIDED_LIGHTING
				#pragma shader_feature _LIMIT_ILLUMINATION
				#pragma shader_feature _MAX_ILLUMINATION
