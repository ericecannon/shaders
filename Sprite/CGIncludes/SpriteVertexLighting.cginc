...
#if defined(SPECULAR) && (_DUAL_SIDED_LIGHTING == 0)
...
VertexOutput vert(VertexInput input)
{
    ...
    //COSMICAT EDIT
	#if (_LIMIT_ILLUMINATION != 0)
	diffuse = min(diffuse, _MAX_ILLUMINATION);
	#endif
